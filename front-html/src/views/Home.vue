...
<template>
  <div class="home-page">
    ...
    <section class="hero">
      <div class="hero-bg">
        <div class="gradient-blob" style="top: -120px; left: 10%; width: 500px; height: 500px; background: var(--accent-purple);"></div>
        <div class="gradient-blob" style="top: 50px; right: -80px; width: 400px; height: 400px; background: var(--accent-blue);"></div>
        <div class="gradient-blob" style="bottom: -100px; left: 40%; width: 350px; height: 350px; background: var(--accent-cyan);"></div>
      </div>
      <div class="hero-content">
        <h1 class="hero-title">
          让抽象概念，<span class="text-gradient">动</span>起来
        </h1>
        ...
        <div class="hero-tags">
          <span>热门：</span>
          <el-tag v-for="t in ['快速排序','二叉树遍历','傅里叶变换','Dijkstra算法']" :key="t" size="default" class="hero-tag" @click="router.push({path:'/sandbox', query:{prompt:t}})">
            {{ t }}
          </el-tag>
        </div>
      </div>
    ...
    <section class="section">
      <h2 class="section-title">探索知识领域</h2>
    ...
    <section class="section stats-section">
      <div class="stats-row">
        <StatCard label="知识词条" :value="80" suffix="+" color="#7c3aed" />
